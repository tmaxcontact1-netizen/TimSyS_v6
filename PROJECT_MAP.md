...
Memecoined will be one TypeScript application with a deterministic domain core, a PostgreSQL persistence layer, provider adapters, background workers, a Telegram operator interface, and offline evaluation/reporting tools.
