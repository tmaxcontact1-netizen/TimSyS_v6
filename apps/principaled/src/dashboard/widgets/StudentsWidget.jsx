...
function StudentsWidget({
  ...
  const [formData, setFormData] = useState({
    ...
    homeroom: "",
    school_year: "",
    medical_alert_flag: 0,
    special_education_flag: 0,
    gifted_talented_flag: 0,
    esl_flag: 0,
    photo_url: "",
    notes: "",
  });
  ...
  const handleSubmit = async (e) => {
    ...
    if (
      ...
      setSubmitError(
        "Student ID, first name, last name, date of birth, and sex are required",
      );
      return;
    }
    setSubmitting(true);
  ...
  const handleEditClick = (r) => {
    ...
    setFormData({
      ...
      medical_alert_flag: r.medical_alert_flag || 0,
      special_education_flag: r.special_education_flag || 0,
      gifted_talented_flag: r.gifted_talented_flag || 0,
      esl_flag: r.esl_flag || 0,
        ...
        <div className="bg-gray-900 border border-gray-800 rounded-lg p-6 mb-6">
          ...
          <form onSubmit={handleImportSubmit}>
            ...
            <p className="text-gray-500 text-xs mb-4">
              Required: student_id, first_name, last_name, date_of_birth, sex.
              Optional: middle_name, nationality, ethnicity, primary_language,
              secondary_language, enrollment_date, enrollment_status,
              current_grade_level, homeroom, school_year, medical_alert_flag,
              special_education_flag, gifted_talented_flag, esl_flag, photo_url,
              notes
            </p>
            <div className="flex gap-3">
              <button
      ...
      {showForm && (
        <div className="bg-gray-900 border border-gray-800 rounded-lg p-6 mb-6">
          ...
          >
            ...
            <div>
              <label className="block text-gray-400 text-xs mb-1">Sex *</label>
              <select
                value={formData.sex}
                onChange={(e) =>
            ...
            <div>
              ...
              <input
                ...
                onChange={(e) =>
                  setFormData({ ...formData, primary_language: e.target.value })
                }
                className="w-full bg-gray-800 border border-gray-700 rounded px-3 py-2 text-white text-sm focus:outline-none focus:border-timsys-primary"
              />
            </div>
            ...
            <div>
              ...
              <input
                ...
                onChange={(e) =>
                  setFormData({
                    ...formData,
                    current_grade_level: e.target.value,
                  })
                }
                className="w-full bg-gray-800 border border-gray-700 rounded px-3 py-2 text-white text-sm focus:outline-none focus:border-timsys-primary"
              />
            ...
            <div>
              ...
              <input
                ...
                onChange={(e) =>
                  setFormData({ ...formData, homeroom: e.target.value })
                }
                className="w-full bg-gray-800 border border-gray-700 rounded px-3 py-2 text-white text-sm focus:outline-none focus:border-timsys-primary"
              />
            </div>
            ...
            <div>
              ...
              <input
                type="checkbox"
                checked={formData.medical_alert_flag === 1}
                onChange={(e) =>
                  setFormData({
                    ...formData,
                    medical_alert_flag: e.target.checked ? 1 : 0,
                  })
                }
                className="ml-2"
              />
            ...
            <div>
              ...
              <input
                type="checkbox"
                checked={formData.special_education_flag === 1}
                onChange={(e) =>
                  setFormData({
                    ...formData,
                    special_education_flag: e.target.checked ? 1 : 0,
                  })
                }
                className="ml-2"
              />
            ...
            <div>
              ...
              <input
                type="checkbox"
                checked={formData.gifted_talented_flag === 1}
                onChange={(e) =>
                  setFormData({
                    ...formData,
                    gifted_talented_flag: e.target.checked ? 1 : 0,
                  })
                }
                className="ml-2"
              />
            ...
            <div>
              ...
              <input
                type="checkbox"
                checked={formData.esl_flag === 1}
                onChange={(e) =>
                  setFormData({
                    ...formData,
                    esl_flag: e.target.checked ? 1 : 0,
                  })
                }
                className="ml-2"
              />
