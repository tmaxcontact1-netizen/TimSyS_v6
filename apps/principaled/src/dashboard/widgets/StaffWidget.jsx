...
function StaffWidget({
  ...
  const handleSubmit = async (e) => {
    ...
    if (
      ...
      setSubmitError(
        "Staff ID, first name, last name, hire date, and employment type are required",
      );
      return;
    }
    setSubmitting(true);
        ...
        <div className="bg-gray-900 border border-gray-800 rounded-lg p-6 mb-6">
          ...
          <form onSubmit={handleImportSubmit}>
            ...
            <p className="text-gray-500 text-xs mb-4">
              Required: staff_id, first_name, last_name, hire_date,
              employment_type. Optional: middle_name, date_of_birth, sex,
              nationality, national_insurance_number, department, job_title,
              work_email, work_phone, phone_primary, phone_secondary,
              email_work, email_personal, dbs_check_status, dbs_check_date,
        ...
        <div className="bg-gray-900 border border-gray-800 rounded-lg p-6 mb-6">
          ...
          >
            ...
            <div>
              ...
              <select
                value={formData.dbs_check_status}
                onChange={(e) =>
                  setFormData({ ...formData, dbs_check_status: e.target.value })
                }
                className="w-full bg-gray-800 border border-gray-700 rounded px-3 py-2 text-white text-sm focus:outline-none focus:border-timsys-primary"
              >
            ...
            <div>
              ...
              <input
                ...
                onChange={(e) =>
                  setFormData({ ...formData, dbs_check_date: e.target.value })
                }
                className="w-full bg-gray-800 border border-gray-700 rounded px-3 py-2 text-white text-sm focus:outline-none focus:border-timsys-primary"
              />
            </div>
            <div>
              ...
              <input
                ...
                onChange={(e) =>
                  setFormData({ ...formData, dbs_expiry_date: e.target.value })
                }
                className="w-full bg-gray-800 border border-gray-700 rounded px-3 py-2 text-white text-sm focus:outline-none focus:border-timsys-primary"
              />
            </div>
            ...
            <div className="md:col-span-3">
              ...
              <textarea
                value={formData.qualifications_summary}
                onChange={(e) =>
                  setFormData({
                    ...formData,
                    qualifications_summary: e.target.value,
                  })
                }
                className="w-full bg-gray-800 border border-gray-700 rounded px-3 py-2 text-white text-sm focus:outline-none focus:border-timsys-primary"
                rows="2"
