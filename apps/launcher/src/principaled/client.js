...
export const withdrawStudent = (id) => client.patch(`/students/${id}/withdraw`);
export const reinstateStudent = (id) => client.patch(`/students/${id}/reinstate`);
...
export const withdrawStaff = (id) => client.patch(`/staff/${id}/withdraw`);
export const reinstateStaff = (id) => client.patch(`/staff/${id}/reinstate`);
