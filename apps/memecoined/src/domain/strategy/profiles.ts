...
export const tradingProfileCatalogue: readonly TradingProfileDefinition[] = Object.freeze([
  ...
  },
  {
    ...
    evidenceMessage: "Needs stored price history so a breakout and subsequent retest can be proved.",
  },
  {
  ...
  },
  {
    ...
    trailingStopBps: 650,
    evidenceStatus: "awaiting_data",
    evidenceMessage: "Needs stored price history to distinguish recovery from a continuing decline.",
  },
  {
