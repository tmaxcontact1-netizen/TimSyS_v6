...
export const tradingProfileCatalogue: readonly TradingProfileDefinition[] = Object.freeze([
  ...
  },
  {
    ...
    approach: "Tracks persistent executable-price oscillation using return sign changes, then waits for an oversold or midpoint rebound before entering.",
    decisionModel: "Persistent 30-minute oscillation regime + 20-sample entry window + rebound transition + round-trip friction",
