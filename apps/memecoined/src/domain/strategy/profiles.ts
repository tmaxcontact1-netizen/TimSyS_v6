...
export const tradingProfileCatalogue: readonly TradingProfileDefinition[] = Object.freeze([
  ...
  },
  {
    ...
    decisionModel: "Per-token executable range + short momentum or pullback recovery + volume, liquidity and buyer confirmation",
    defaultAllocationBps: 1500,
  ...
  },
  {
    ...
    decisionModel: "Sustained trend + strong liquidity + broad holders + transaction-quality confirmation",
