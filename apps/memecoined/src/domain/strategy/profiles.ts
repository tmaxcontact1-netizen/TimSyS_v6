...
export const tradingProfileCatalogue: readonly TradingProfileDefinition[] = Object.freeze([
  {
    ...
    approach: "Learns per-token targets, loss limits, trailing protection and time limits without relaxing security gates.",
    decisionModel: "Five-minute executable-price bars + EMA slope + RSI + acceleration + per-token volatility + market confirmation",
  ...
  },
  {
    ...
    decisionModel: "Established EMA trend + MACD + RSI + trend efficiency + strong liquidity and transaction quality",
  ...
  },
  {
    ...
    decisionModel: "EMA and MACD trend + positive acceleration + RSI + trend efficiency + stable liquidity",
    defaultAllocationBps: 2000,
    maximumConcurrentPositions: 3,
    riskPerTradeBps: 35,
    minimumCandidateScore: 45,
  ...
  },
  {
    ...
    decisionModel: "Liquidity, momentum, holders and transaction quality + independent quote and safety agreement",
    defaultAllocationBps: 1500,
    maximumConcurrentPositions: 2,
    riskPerTradeBps: 25,
    minimumCandidateScore: 60,
    ...
    evidenceMessage: "Uses the independent market, executable-quote, holder and dual-RPC safety evidence currently collected.",
  },
  {
    id: "breakout_retest",
  ...
  },
  {
    ...
    approach: "Requires a young verified pool, expanding liquidity and confirmed executable market activity.",
    decisionModel: "Verified pool age + liquidity expansion + buyer and executable-price confirmation",
    defaultAllocationBps: 500,
    maximumConcurrentPositions: 2,
    riskPerTradeBps: 20,
    ...
    trailingStopBps: 900,
    evidenceStatus: "ready",
    evidenceMessage: "Uses verified pool creation time, liquidity growth, market activity and executable quotes; it does not infer an unobserved launch-platform graduation event.",
  },
  {
    id: "scalper",
  ...
  },
  {
    ...
    approach: "Measures executable-price crossings, negative return autocorrelation, RSI extremes and friction before entering a brief mean-reversion trade.",
    decisionModel: "30-minute executable-price window + oscillation score + oversold or midpoint rebound + round-trip friction",
    ...
    trailingStopBps: 50,
    evidenceStatus: "ready",
    evidenceMessage: "Uses executable Jupiter quotes and current pool activity; every signal and outcome is retained for validation.",
  },
  ...([
