...
export default defineConfig({
  test: {
    ...
    include: [
      ...
      "tests/unit/operational-governance.test.ts",
      "tests/unit/provider-readiness.test.ts",
      "tests/unit/operator-approval.test.ts",
      "tests/unit/telegram-operator.test.ts",
      "tests/integration/execution.test.ts",
      "tests/integration/candidate-discovery.test.ts",
      "tests/integration/acquisition-schedule.test.ts",
      ...
      "tests/integration/paper-accounting.test.ts",
      "tests/integration/paper-entry-work.test.ts",
      "tests/integration/paper-composition.test.ts",
      "tests/integration/paper-risk-authority.test.ts",
      "tests/integration/operator-approvals.test.ts",
      "tests/integration/prepared-entry-executions.test.ts",
      "tests/integration/live-entry-reconciliation.test.ts",
      ...
      "tests/e2e/profile-paper-path.test.ts",
      "tests/unit/adaptive-calibration.test.ts",
      "tests/unit/technical-analysis.test.ts",
      ...
      "tests/unit/paper-operator-controls.test.ts",
      ...
      "tests/e2e/observation.test.ts",
      "tests/e2e/shadow.test.ts",
      "tests/e2e/paper.test.ts",
      "tests/e2e/live-low-value.test.ts",
      "tests/e2e/failure-recovery.test.ts",
    ],
