...
const paperColumns = [
  ...
  "paper_fast_market_observations.output_amount_raw",
      ...
      "paper_fast_market_observations.liquidity_usd",
      "paper_fast_market_observations.five_minute_volume_usd",
      "paper_fast_market_observations.five_minute_buys",
      "paper_fast_market_observations.five_minute_sells",
      "paper_fast_market_observations.five_minute_price_change",
      "paper_fast_market_observations.one_hour_price_change",
      "paper_fast_market_observations.market_evidence_json",
