...
| `/src/entrypoints/dashboard.ts`         | TypeScript | Serves the local read-only paper snapshot and dashboard assets                                            | Runtime config; database readiness; paper reporting                        | Operator-started local dashboard process | Node.js native HTTP server                       |
