...
| `/frontend`           | Dependency-free local paper dashboard assets, including responsive navigation, browser-local display preferences, persistent watchlist CRUD, safe legacy-list import, and portfolio views |
