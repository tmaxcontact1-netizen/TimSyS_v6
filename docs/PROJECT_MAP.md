...
| `/frontend`           | Dependency-free local paper dashboard assets, including responsive navigation, browser-local theme, accessibility, layout and panel preferences, preference transfer, watchlist, and portfolio views |
...
| `/src/entrypoints/dashboard.ts`         | TypeScript | Serves local paper observations plus authenticated, origin-checked persistent watchlist mutations; holds no trading authority | Runtime config; database readiness; paper reporting and watchlist persistence | Operator-started local dashboard process | Node.js native HTTP server                       |
