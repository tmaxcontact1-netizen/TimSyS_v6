...
describe('Contract Verification', function() {
  ...
  describe('Intelligence Contract', function() {
    ...
    test('createProduct method exists', function() {
      expect(typeof impl.createProduct).toBe('function');
    });

    test('listProducts method exists', function() {
      expect(typeof impl.listProducts).toBe('function');
    });
