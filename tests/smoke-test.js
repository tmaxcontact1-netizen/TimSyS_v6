...
process.chdir(path.join(__dirname, '../platform'));

const { bootPlatform, shutdownPlatform } = require('../platform');
const db = require('../platform/shared/services/db');
const moduleRegistry = require('../platform/shared/registry/moduleRegistry');
const routeRegistry = require('../platform/shared/registry/routeRegistry');
const functionRegistry = require('../platform/shared/registry/functionRegistry');
const componentRegistry = require('../platform/shared/registry/componentRegistry');
...
async function runSmokeTest() {
  ...
  try {
    ...
    for (const svc of services) {
      try {
        const svcModule = require(`../platform/shared/services/${svc}`);
